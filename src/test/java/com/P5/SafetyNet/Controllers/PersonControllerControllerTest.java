...
public class PersonControllerControllerTest {
    ...
    public void testSavePerson() throws Exception {
        ...
        this.mockMvc.perform(post("/assignedPersons").contentType(MediaType.APPLICATION_JSON).content(personJson))
    ...
    public void testGetPersons() throws Exception {
        ...
        this.mockMvc.perform(get("/assignedPersons").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk());
    ...
    public void testGetPerson() throws Exception {
        ...
        this.mockMvc.perform(get("/assignedPersons/1"))
    ...
    @Test void testUpdatePerson() throws Exception {
       ...
       this.mockMvc.perform(put("/assignedPersons/1")
    ...
    void testDeletePerson() throws Exception {
        ...
        this.mockMvc.perform(delete("/assignedPersons/1"))
                .andExpect(status().isOk());
